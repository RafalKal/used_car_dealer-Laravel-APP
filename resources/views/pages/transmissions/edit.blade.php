...
@section('content')
    ...
    <div class="d-flex flex-column w-100">
        ...
        <h3><span class="label label-default">EDIT CHOSEN TRANSMISSION TYPE</span></h3>

        <br>

        {{-- EDIT TRANSMISSIONS FORM --}}
        <form class="w-50 m-auto" method="post" action="{{route('transmissions.edit.perform', $transmission->id)}}">
